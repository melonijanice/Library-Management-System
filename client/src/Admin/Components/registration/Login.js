  ...
  const onSubmitHandler = (e) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        console.log(res);
        //localStorage.setItem("userData", res.data.userLoggedIn);
        localStorage.user = JSON.stringify(res.data.userLoggedIn);
        
        if (res.data.userLoggedIn.Role === "admin" && props.isLibraryHome==="true") {
          navigate(`/library/home`);
        } else if(props.isLibraryHome==="true") {
          navigate(`/library/home`);
        }
        else if (res.data.userLoggedIn.Role === "admin")
        {
          navigate(`/admin/home`);
        }
        else
